/**
 * Système de rendu : dessine la scène sur un <canvas>.
 * On dessine dans cet ordre :
 *   1. fond + grille + chemin
 *   2. tours (avec cercle de portée)
 *   3. ennemis (avec barre de vie)
 *   4. projectiles
 */
...
export function render(ctx: CanvasRenderingContext2D, state: GameState) {
  ...
  for (const e of state.enemies) {
    ...
    // Barre de vie (valeur max "60" pour l'échelle de couleur simple)
